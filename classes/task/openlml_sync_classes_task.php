...
/**
 * Scheduled task for processing openlml classes enrolments.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class openlml_sync_classes_task extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('openlmlclasssync', 'enrol_openlml');
    }
